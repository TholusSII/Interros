...
% Packages techniques repris à l'identique du framework des khôlles.
% Ils sont restaurés depuis framework/vendor/ avant la compilation GitHub.
\IfFileExists{../../framework/rpcinematik.sty}{%
  \RequirePackage{../../framework/rpcinematik}%
}{%
  \PackageWarningNoLine{interros-framework}{rpcinematik.sty absent; exécuter la préparation du framework}%
}
\IfFileExists{../../framework/rp-sysml.sty}{%
  \RequirePackage{../../framework/rp-sysml}%
}{%
  \PackageWarningNoLine{interros-framework}{rp-sysml.sty absent; exécuter la préparation du framework}%
}
