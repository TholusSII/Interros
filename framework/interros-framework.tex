...
% Le framework des khôlles définit déjà l'environnement question.
% Pour les interros, on réutilise son compteur et on remplace uniquement
% la commande d'ouverture par une commande compacte à deux arguments.
\renewcommand{\question}[2]{\refstepcounter{question}\par\medskip\noindent\textbf{Question \thequestion :}\quad #1\hfill\textbf{(#2 points)}\par\smallskip}
\renewcommand{\resetquestions}{\setcounter{question}{0}}
